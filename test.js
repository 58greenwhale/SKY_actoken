...
, function(e, t, n) {
    ...
    , s = n(1), u = n(17), f = document.createElement("div"), j = /^(?:click|dblclick|contextmenu|DOMMouseScroll|(mouse|touch|pointer)(?:\w+))$/, c = document;
...
, function(e, t) {
    ...
    , l = "prototype", s = 100, u = 200, f = 300, j = 500, c = 501, d = 502, h = 503, p = 504, y = 600, v = 1e3, g = (o = {},
    n(o, s, "script error"),
    n(o, u, "business error"),
    n(o, f, "unpass error"),
    n(o, j, "request error"),
    n(o, c, "request api error"),
    n(o, d, "request script error"),
    n(o, h, "request img error"),
    n(o, p, "request timeout error"),
    n(o, y, "request anticheat token error"),
    n(o, v, "unknown error"),
    o);
    i(r, Error),
    ...
    ,
    r.set = function(e, t) {
        "number" == typeof e && "string" == typeof t && (g[e] = t),
        "object" === ("undefined" == typeof e ? "undefined" : a(e)) && e && Object.assign(g, e)
    }
    ,
    r.get = function(e) {
        return g[e]
    ...
    t.UNPASS_ERROR = f,
    t.REQUEST_ERROR = j,
    t.REQUEST_API_ERROR = c,
    t.REQUEST_SCRIPT_ERROR = d,
    t.REQUEST_IMG_ERROR = h,
    t.REQUEST_TIMEOUT_ERROR = p,
    t.ANTICHEAT_TOKEN_ERROR = y,
    t.UNKNOWN_ERROR = v
}
, function(e, t, n) {
    function i(e) {
...
, function(e, t, n) {
    ...
    var o, a = n(1), l = n(2), s = n(3), u = s.CAPTCHA_TYPE, f = s.CAPTCHA_CLASS, j = s.WIDTH_LIMIT, c = s.MAX_VERIFICATION, d = s.RTL_LANGS, h = s.FEEDBACK_URL, p = n(17), y = n(4), v = y.SWITCH_TYPE, g = y.INVOKE_HOOK, b = y.EVENT_RESET, m = y.SWITCH_LOAD_STATUS, _ = y.UPDATE_VERIFY_STATUS, T = y.REFRESH, w = y.EVENT_RESET_CLASSIC, S = y.SET_TOKEN, E = n(12), R = E.FETCH_CAPTCHA, C = E.VERIFY_CAPTCHA, k = E.RESET_STATE, O = n(24), X = n(25), $ = n(26), I = n(23);
    e.exports = {
        el: ".yidun",
        template: n(54),
        props: {
        ...
        i(o, "." + f.REFRESH + " click", function(e) {
            e.stopPropagation(),
            this.$store.state.countsOfVerifyError > c || "verifying" === this.$store.state.verifyStatus && this.captchaType !== u.SMS || "loading" === this.load.status || this.refresh()
        }),
        i(o, ".yidun_tips__text click", function() {
            this.$store.state.countsOfVerifyError > c && this.$store.commit(w)
        }),
        o),
        watch: {
...
, function(e, t, n) {
    ...
    var r, o = n(20), a = n(16), l = n(5), s = l.REQUEST_SCRIPT_ERROR, u = l.REQUEST_API_ERROR, f = l.REQUEST_IMG_ERROR, j = l.BUSINESS_ERROR, c = l.UNPASS_ERROR, d = l.ANTICHEAT_TOKEN_ERROR, h = n(19), p = n(8), y = n(1), v = y.uuid, g = (r = {},
    i(r, u, "api"),
    i(r, f, "image"),
    i(r, s, "script"),
    i(r, j, "business"),
    ...
    e.exports = function(e, t, n) {
        var i = t.protocol
          ...
          , d = c(r || s.apiServer || ["c.dun.163yun.com", "c.dun.163.com"])
          , y = o({
            timeout: f,
            disableRetry: !0
        })
    ...
    e.exports = r._extend({
        ...
        methods: {
            ...
            changeLoadStatus: function(e) {
                ...
                "loading" === e.status && t) {
                    var n = this.$store.state
                      ...
                      , u = o.find(".yidun_bg-img", this.$el)
                      , f = o.find("." + s.JIGSAW, this.$el)
                      , j = this.$store.commit
                      , h = m(a, {
                        token: t.token
                    });
            ...
            restrict: function(e, t) {
                if (e) {
                    var n, i, r = this.drag, o = r.startLeft, a = r.dragX, l = this.width, s = e.offsetWidth, u = this.$slider.offsetWidth, f = l - s, j = o + a, c = t < 0 ? -t : t / 2;
                    return e === this.$jigsaw && (a <= c ? (n = a,
                    i = t < 0 ? -n / 2 : n,
                    j += i) : l - a - u <= c ? (n = a - (l - u - c),
                    i = t < 0 ? -n / 2 : n,
                    j += t / 2 + i) : j += t / 2),
                    j <= 0 && (j = 0),
                    j >= f && (j = f),
...
, function(e, t, n) {
    ...
    var r, o = n(6), a = n(2), l = n(1), s = n(7), u = s.eypt, f = s.xor_encode, j = n(3), c = j.CAPTCHA_TYPE, d = j.CAPTCHA_CLASS, h = j.SAMPLE_NUM, p = j.MAX_VERIFICATION, y = j.RTL_LANGS, v = n(4), g = v.SWITCH_LOAD_STATUS, b = v.INVOKE_HOOK, m = n(5), _ = m.REQUEST_IMG_ERROR, T = n(8), w = n(9);
    e.exports = o._extend({
        "abstract": !0,
                ...
                var n = function(n) {
                    C.all([new C(function(i, r) {
                        var o = t.$store.state.token
                          ...
                          , u = l.top
                          , f = g.now()
                          , j = w(o, [Math.round(e.clientX - s), Math.round(e.clientY - u), f - (t.beginTime || f)] + "")
                        ...
                        t.$store.dispatch(a, {
                            ...
                            data: JSON.stringify({
                                d: "",
                                m: T(g.sample(c, p).join(":")),
                                p: T(j),
                                ext: T(w(o, "1," + c.length))
                            })
                        }, function(e, t) {
...
, function(e, t) {
    ...
    function i(e, t, i, a) {
        ...
        t = null),
        a || (a = {});
        var f, j, c = Math.random().toString(36).slice(2, 9), d = a.prefix || "__JSONP", h = a.name || d + ("_" + c) + ("_" + o++), p = a.param || "callback", y = a.timeout || 6e3, v = window.encodeURIComponent, g = document.getElementsByTagName("script")[0] || document.head;
            ...
            !function() {
                ...
                !function() {
                    ...
                    function _(e) {
                        ...
                        n.push(e);
                        try {
                            for (var f, j = e + s[0], c = t[9], d = t[9], h = t[9]; h < j.length; h++)
                                try {
                        ...
                        try {
                            ...
                            for (var K = I.length, q = t[9]; q < K; q++) {
                                ...
                                null == V)
                                    ...
                                    for (var je = b(t[91]), H = [], ce = V.length, ve = t[9]; ve < ce; ve++)
                                        H.push(v(V[ve], je--));
                                    re = H
                                }
                                if (V = re,
